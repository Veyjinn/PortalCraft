<script lang="ts" context="module">
	// Source: https://codepen.io/b1tn3r/pen/YjOzRv
...
<script lang="ts">
	...
	export let size: ButtonSize = ButtonSize.STANDARD;
	...
	function handleMouseDown(this: HTMLElement) {
	...
	function handleMouseMove(this: HTMLElement, e: MouseEvent) {
		...
		const clearedClassList = this.className.replace(/btn-center|btn-right|btn-left/gi, '').trim();
		this.className = clearedClassList + ' ' + newClass;
	}
</script>

<div role="button" class={`retro-btn ${type} ${size}`}>
	<a href="#" class="btn">
